/*
   ...
   Purpose: Define values of this node and pointers to previou and next node.
*/
...
class LinkedNodeClass
{
    ...
    public:
        ...
        // and assigns them.
        LinkedNodeClass(
            LinkedNodeClass *inPrev,  // Address of node that comes before 
                                      // this one
            const T &inVal,           // Value to be contained in this node
            LinkedNodeClass *inNext); // Address of node that comes after 
                                      // this one
